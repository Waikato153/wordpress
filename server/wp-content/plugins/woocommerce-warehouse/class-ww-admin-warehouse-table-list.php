 ...
 */
class WW_Admin_Webhooks_Table_List extends WP_List_Table {
	...
	public function column_title( $webhook ) {
		$edit_link = admin_url( 'admin.php?page=wc-settings&amp;tab=warehouse&amp;edit-warehouse=' . $webhook->get_id() );
		$output    = '';
	...
	protected function get_views() {
		...
		$statuses       = array_keys( wc_get_warehouse_statuses() );
	...
	public function prepare_items() {
		...
		$this->items = array_map( 'wc_get_warehouse', $webhooks->webhooks );
