...
class WW_Data_Store {
	...
	private $stores = array(
		'warehouse'               => 'WW_Warehouse_Data_Store',
	);
	...
	public function __construct( $object_type ) {
		...
		if ( array_key_exists( $object_type, $this->stores ) ) {
			$store = apply_filters( 'woocommerce_ww_' . $object_type . '_data_store', $this->stores[ $object_type ] );
			if ( is_object( $store ) ) {
	...
	public static function load( $object_type ) {
		return new WW_Data_Store( $object_type );
	}
