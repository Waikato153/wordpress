 ...
 * Settings for API.
 */
if ( class_exists( 'WO_Settings_Advanced', false ) ) {
	return new WO_Settings_Advanced();
}

/**
 * WC_Settings_Advanced.
 */
class WO_Settings_Advanced extends WO_Settings_Page {
	...
	public function __construct() {
		$this->id    = 'advanced';
		$this->label = __( 'Warehouse', 'woocommerce' );
